...
public class Menu {
	...
	public static void userLogin() {
		String username=Customers.username;
	...
	public static void createNewCustomer() {
		...
		String accountNum = null;// generate account number

		// figure out how to assign the next account number available
		...
		System.out.println("Great! You've just submitted your application to open a new account."
	...
	public static void viewCustomerInfo() {
		...
		System.out.println(
				"Customer name: " + a.getFirstName() + a.getLastName() + "\nCustomer Username: " + a.getUsername()
